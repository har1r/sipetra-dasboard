...
export const createTaskSchema = z.object({
  ...
  baseData: z
    .object({
      ...
      taxObjectSubdistrict: z
        .enum(Object.keys(SUBDISTRICT_DATA))
        .describe("Kecamatan objek pajak wajib diisi"),
      taxObjectVillage: z
        .enum(Object.values(SUBDISTRICT_DATA).flat())
        .describe("Kelurahan objek pajak wajib diisi"),
      landArea: z
        .number()
        .positive("Luas tanah harus lebih besar dari 0")
        .describe("Luas tanah wajib diisi"),
      buildingArea: z
        .number()
        .positive("Luas bangunan harus lebih besar dari 0")
        .describe("Luas bangunan wajib diisi"),
    })
    .optional()
    .describe(
      "Data dasar boleh tidak diisi jika jenis permohonan objek pajak baru dan pengaktifan",
    ),
    ...
    .array(
      z.object({
        driveLink: z
          ...
          .describe("Link drive wajib diisi"),
        linkName: z.string().describe("Nama link wajib diisi"),
      }),
    )
    .optional()
    .describe("Lampiran diisi pada tahap pengarsipan"),
});
